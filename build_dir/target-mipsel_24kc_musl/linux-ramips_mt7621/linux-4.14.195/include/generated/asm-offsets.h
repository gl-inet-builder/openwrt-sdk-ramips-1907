...
#define TASK_MM 500 /* offsetof(struct task_struct, mm) */
#define TASK_PID 632 /* offsetof(struct task_struct, pid) */
#define TASK_STACK_CANARY 640 /* offsetof(struct task_struct, stack_canary) */
#define TASK_STRUCT_SIZE 1632 /* sizeof(struct task_struct) */
...
#define THREAD_REG16 1208 /* offsetof(struct task_struct, thread.reg16) */
#define THREAD_REG17 1212 /* offsetof(struct task_struct, thread.reg17) */
#define THREAD_REG18 1216 /* offsetof(struct task_struct, thread.reg18) */
#define THREAD_REG19 1220 /* offsetof(struct task_struct, thread.reg19) */
#define THREAD_REG20 1224 /* offsetof(struct task_struct, thread.reg20) */
#define THREAD_REG21 1228 /* offsetof(struct task_struct, thread.reg21) */
#define THREAD_REG22 1232 /* offsetof(struct task_struct, thread.reg22) */
#define THREAD_REG23 1236 /* offsetof(struct task_struct, thread.reg23) */
#define THREAD_REG29 1240 /* offsetof(struct task_struct, thread.reg29) */
#define THREAD_REG30 1244 /* offsetof(struct task_struct, thread.reg30) */
#define THREAD_REG31 1248 /* offsetof(struct task_struct, thread.reg31) */
#define THREAD_STATUS 1252 /* offsetof(struct task_struct, thread.cp0_status) */
#define THREAD_FPU 1256 /* offsetof(struct task_struct, thread.fpu) */
#define THREAD_BVADDR 1592 /* offsetof(struct task_struct, thread.cp0_badvaddr) */
#define THREAD_BUADDR 1596 /* offsetof(struct task_struct, thread.cp0_baduaddr) */
#define THREAD_ECODE 1600 /* offsetof(struct task_struct, thread.error_code) */
#define THREAD_TRAPNO 1604 /* offsetof(struct task_struct, thread.trap_nr) */

#define THREAD_FPR0 1256 /* offsetof(struct task_struct, thread.fpu.fpr[0]) */
#define THREAD_FPR1 1264 /* offsetof(struct task_struct, thread.fpu.fpr[1]) */
#define THREAD_FPR2 1272 /* offsetof(struct task_struct, thread.fpu.fpr[2]) */
#define THREAD_FPR3 1280 /* offsetof(struct task_struct, thread.fpu.fpr[3]) */
#define THREAD_FPR4 1288 /* offsetof(struct task_struct, thread.fpu.fpr[4]) */
#define THREAD_FPR5 1296 /* offsetof(struct task_struct, thread.fpu.fpr[5]) */
#define THREAD_FPR6 1304 /* offsetof(struct task_struct, thread.fpu.fpr[6]) */
#define THREAD_FPR7 1312 /* offsetof(struct task_struct, thread.fpu.fpr[7]) */
#define THREAD_FPR8 1320 /* offsetof(struct task_struct, thread.fpu.fpr[8]) */
#define THREAD_FPR9 1328 /* offsetof(struct task_struct, thread.fpu.fpr[9]) */
#define THREAD_FPR10 1336 /* offsetof(struct task_struct, thread.fpu.fpr[10]) */
#define THREAD_FPR11 1344 /* offsetof(struct task_struct, thread.fpu.fpr[11]) */
#define THREAD_FPR12 1352 /* offsetof(struct task_struct, thread.fpu.fpr[12]) */
#define THREAD_FPR13 1360 /* offsetof(struct task_struct, thread.fpu.fpr[13]) */
#define THREAD_FPR14 1368 /* offsetof(struct task_struct, thread.fpu.fpr[14]) */
#define THREAD_FPR15 1376 /* offsetof(struct task_struct, thread.fpu.fpr[15]) */
#define THREAD_FPR16 1384 /* offsetof(struct task_struct, thread.fpu.fpr[16]) */
#define THREAD_FPR17 1392 /* offsetof(struct task_struct, thread.fpu.fpr[17]) */
#define THREAD_FPR18 1400 /* offsetof(struct task_struct, thread.fpu.fpr[18]) */
#define THREAD_FPR19 1408 /* offsetof(struct task_struct, thread.fpu.fpr[19]) */
#define THREAD_FPR20 1416 /* offsetof(struct task_struct, thread.fpu.fpr[20]) */
#define THREAD_FPR21 1424 /* offsetof(struct task_struct, thread.fpu.fpr[21]) */
#define THREAD_FPR22 1432 /* offsetof(struct task_struct, thread.fpu.fpr[22]) */
#define THREAD_FPR23 1440 /* offsetof(struct task_struct, thread.fpu.fpr[23]) */
#define THREAD_FPR24 1448 /* offsetof(struct task_struct, thread.fpu.fpr[24]) */
#define THREAD_FPR25 1456 /* offsetof(struct task_struct, thread.fpu.fpr[25]) */
#define THREAD_FPR26 1464 /* offsetof(struct task_struct, thread.fpu.fpr[26]) */
#define THREAD_FPR27 1472 /* offsetof(struct task_struct, thread.fpu.fpr[27]) */
#define THREAD_FPR28 1480 /* offsetof(struct task_struct, thread.fpu.fpr[28]) */
#define THREAD_FPR29 1488 /* offsetof(struct task_struct, thread.fpu.fpr[29]) */
#define THREAD_FPR30 1496 /* offsetof(struct task_struct, thread.fpu.fpr[30]) */
#define THREAD_FPR31 1504 /* offsetof(struct task_struct, thread.fpu.fpr[31]) */
#define THREAD_FCR31 1512 /* offsetof(struct task_struct, thread.fpu.fcr31) */
#define THREAD_MSA_CSR 1516 /* offsetof(struct task_struct, thread.fpu.msacsr) */
