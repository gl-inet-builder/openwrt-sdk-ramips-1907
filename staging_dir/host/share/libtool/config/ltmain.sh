...
if test -n "$STAGING_DIR"; then
	...
	: ${EGREP="/work/work/openwrt190704/gl-image/openwrt-19.07.4.git/staging_dir/host/bin/grep -E"}
	: ${FGREP="/work/work/openwrt190704/gl-image/openwrt-19.07.4.git/staging_dir/host/bin/grep -F"}
	: ${GREP="/work/work/openwrt190704/gl-image/openwrt-19.07.4.git/staging_dir/host/bin/grep"}
	: ${SED="/work/work/openwrt190704/gl-image/openwrt-19.07.4.git/staging_dir/host/bin/sed"}
fi
